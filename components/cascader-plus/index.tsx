...
export interface CascaderPlusProps extends Omit<RcCascaderProps, 'checkable'> {
  multiple?: boolean;
  size?: SizeType;
  bordered?: boolean;
}
...
const CascaderPlus = React.forwardRef((props: CascaderPlusProps, ref: React.Ref<CascaderRef>) => {
  const {
  ...
  const cascaderPrefixCls = getPrefixCls('cascader-plus', customizePrefixCls);
...
CascaderPlus.displayName = 'Cascader';
